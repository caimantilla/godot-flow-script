...
protected:
	...
	virtual bool exec_variable_assignment(FlowScriptNodeContext *p_context, const StringName &p_key, const Variant &p_value);
...
public:
	...
	void set_variable(const StringName &p_name);
