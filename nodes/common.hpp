#ifndef FLOW_SCRIPT_INCLUDED_NODES_COMMON_HEADER_HPP
#define FLOW_SCRIPT_INCLUDED_NODES_COMMON_HEADER_HPP
...
#endif // FLOW_SCRIPT_INCLUDED_NODES_COMMON_HEADER_HPP
