...
void WaitSecondsFlowNode::_bind_methods()
{
	...
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "timer_duration", PROPERTY_HINT_RANGE, "0.1,500,0.1,suffix:Second(s)", PROPERTY_USAGE_DEFAULT), "set_timer_duration", "get_timer_duration");
